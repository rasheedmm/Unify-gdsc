...
public class ChatListAdapterNew extends RecyclerView.Adapter<ChatListAdapterNew.ChatListViewHolder> {
    ...
    public ChatListAdapterNew(Context context, List<ChatListModel> chatListModelList) {
    ...
    @NonNull
    @Override
    public ChatListAdapterNew.ChatListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ChatListAdapterNew.ChatListViewHolder holder, int position) {
