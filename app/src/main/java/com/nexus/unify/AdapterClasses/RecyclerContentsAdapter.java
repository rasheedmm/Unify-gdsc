...
public class RecyclerContentsAdapter extends RecyclerView.Adapter {
    Context context;
    private static final String TAG = "RecyclerAdapter";
    List<Posts> moviesList;
    private final int limit = 10;
    public RecyclerContentsAdapter(List<Posts> moviesList, Context context) {
...
//        return 1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = layoutInflater.inflate(R.layout.item_contents, parent, false);
...
//        }
        ...
        if (moviesList.get(position).getType().equals("image")) {
            ...
            viewHolderTwo.iv_more.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
