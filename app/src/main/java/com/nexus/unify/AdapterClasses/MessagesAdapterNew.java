...
import com.nexus.unify.ChatActivity;
...
public class MessagesAdapterNew extends RecyclerView.Adapter<MessagesAdapterNew.MessageViewHolder> {
    ...
    public MessagesAdapterNew(Context context, List<MessageModel> messageList) {
    ...
    @NonNull
    @Override
    public MessagesAdapterNew.MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final MessagesAdapterNew.MessageViewHolder holder, int position) {
