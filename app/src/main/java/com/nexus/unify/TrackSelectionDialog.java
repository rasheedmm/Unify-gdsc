...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public static TrackSelectionDialog createForPlayer(
          ExoPlayer player, DialogInterface.OnDismissListener onDismissListener) {
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public View onCreateView(
      ...
      View rootView =
          inflater.inflate(R.layout.track_selection_dialog, container, /* attachToRoot= */ false);
      TrackSelectionView trackSelectionView = rootView.findViewById(R.id.track_selection_dialog_view_pager);
