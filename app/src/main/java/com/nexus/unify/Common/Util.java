package com.nexus.unify.Common;
...
public class Util {
    ...
    public static  void updateChatDetailsNormal(final Context context, final String currentUserId, final String chatUserId, final String lastMessage)
    {
    ...
    {
        final DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        DatabaseReference chatRef = rootRef.child(NodeNames.CHATSANMS).child(chatUserId).child(currentUserId);
        ...
        chatRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Map chatUserMap = new HashMap();
                chatUserMap.put(NodeNames.CHATSANMS +"/" + chatUserId + "/" + currentUserId, chatMap);
