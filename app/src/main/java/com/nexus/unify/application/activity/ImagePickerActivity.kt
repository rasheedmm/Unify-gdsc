...
import com.nexus.latticetkmce.application.activity.ParentActivity
import com.nexus.unify.BuildConfig.APPLICATION_ID
...
class ImagePickerActivity : ParentActivity(R.layout.activity_basic_details) {
    ...
    private fun chooseImage() {
        getPickImageIntent()?.let { startActivityForResult(it, RES_IMAGE) }
    }
